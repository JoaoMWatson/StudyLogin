        ...
        <div class="row">
            <div class="col-lg-10 col-xl-8 mx-auto">
                <div class="card card-signin flex-row my-4">
                    <div class="card-body">
                        <h5 class="text-center">Reenviar Email</h5>
                        ...
                        <form class="form-signin" action="app/controller/UserController.php?action=resendMail" method="POST">
                            <div class="form-label-group">
                                <input type="text" name="mail" id="inputUserame" class="form-control" placeholder="Seu endereco de enderco" required autofocus>
